...
/* ============================================================
   ...
   This is the VPA customers will pay into. The QR generated on
   each bill includes the bill's exact total amount pre-filled.
   ============================================================ */
const UPI_ID = "cozycatkitchen@ptaxis";
const UPI_PAYEE_NAME = "CozyCatKitchen";

/* ============================================================
   Global error visibility + network timeouts
   ------------------------------------------------------------
   Silent failures (e.g. an unhandled promise rejection, or a
   backend request that never returns) are what made past bugs so
   hard to spot. These two utilities make both cases loud:
     • a global handler that logs and shows a dismissible toast
     • fetchWithTimeout() so no request can hang a tab forever
   ============================================================ */
